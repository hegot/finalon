...
public class ReturnonInvestment {
    public static ObservableList<Formula> get(int parent, int counter) {
        ...
        Formulas.add(new Formula(ReturnonInvestment,
                ...
                "ReturnonInvestment",
                "((ProfitLossBeforeTax-IncomeTaxExpenseContinuingOperations+FinanceCosts)/(EquityGeneral[0]/2+EquityGeneral[1]/2+NonCurrentLiabilities[0]/2+NonCurrentLiabilities[1]/2))*100",
                "",
                "formula",
                "%",
                parent));
