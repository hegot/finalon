        ...
        if (periodsArr.size() > 2 && returnOnAssets != null && netProfitMargin != null && totalAssetTurnover != null) {
            ...
            if (returnOnAssetsFirst != null && returnOnAssetsLast != null &&
                ...
                if (returnOnAssetsLast > returnOnAssetsFirst) {
                    prefix.append("Company's return on assets increased from " + returnOnAssetsFirst +
                    ...
                    if (netProfitMarginLast <= netProfitMarginFirst
                        ...
                        prefix.append("The explanation for this trend can be found, as " +
                                "the total asset turnover increased from " + totalAssetTurnoverFirst +
                                " in " + start + " to " + totalAssetTurnoverLast + " in " +
                    ...
                    if (netProfitMarginLast > netProfitMarginFirst
                        ...
                        prefix.append("The explanation for this trend can be found, as both " +
                                ...
                                "Net profit margin increased from " + netProfitMarginFirst + "%  in " + start + " to " +
                                netProfitMarginLast + "% in " + end + ", indicating the amount of the net profit generated by 1 " +
                                currency + " of sales became greater. Total asset turnover grew from " + totalAssetTurnoverFirst +
                                " in " + start + " to " + totalAssetTurnoverLast + " in " + end +
                ...
                if (returnOnAssetsLast < returnOnAssetsFirst) {
                    prefix.append("Company's return on assets decreased from " + returnOnAssetsFirst +
                            "% in " + start + " to " + returnOnAssetsLast + "% in " + end + ". ");
                    if (netProfitMarginLast < netProfitMarginFirst
                            && totalAssetTurnoverLast < totalAssetTurnoverFirst) {
                        prefix.append("The explanation for this trend can be found, as both " +
                                "net profit margin and total asset turnover declined in " + end + " comparing to  " + start + ". " +
                                "Net profit margin decreased from " + netProfitMarginFirst + "%  in " + start + " to " +
                                netProfitMarginLast + "% in " + end + ", indicating the amount of the net profit generated by 1 " +
                                currency + " of sales became smaller. Total asset turnover declined from " + totalAssetTurnoverFirst +
                                " in " + start + " to " + totalAssetTurnoverLast + " in " + end +
                    ...
                    if (netProfitMarginLast >= netProfitMarginFirst
                            && totalAssetTurnoverLast < totalAssetTurnoverFirst) {
                        prefix.append("The explanation for this trend can be found, as the total asset turnover decreased from " + totalAssetTurnoverFirst +
                                " in " + start + " to " + totalAssetTurnoverLast + " in " + end +
