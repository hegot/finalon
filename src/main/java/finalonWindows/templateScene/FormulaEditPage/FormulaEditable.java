...
import finalonWindows.templateScene.FormulaEditPage.IndustryOperations.SortedSections;
...
public class FormulaEditable {
    ...
    private static TreeTableView<Formula> createFormulaTable() {
        ...
        Formula template = DbFormulaHandler.findTemplate(rootId);
        ...
        TreeItem rootNode = getRoot(template);
    ...
    public static void refresh() {
        SceneSwitcher.goTo(SceneName.EDITFORMULAS, rootId);
    }
