package finalonWindows.reusableComponents.calendar;
...
public class FXCalendar extends HBox {
	...
	private void configureCalendar() {
		...
		dateTxtField.getStyleClass().add("textField");
		...
		ImageButton popupButton = new ImageButton("image/calendar.png", 16);
