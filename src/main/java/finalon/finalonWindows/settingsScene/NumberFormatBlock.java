...
import finalon.defaultData.DefaultNumberFormats;
...
public class NumberFormatBlock {
    ...
    public VBox get() {
        ObservableList<finalon.entities.NumberFormat> Formats = DefaultNumberFormats.getFormats();
        ...
        for (finalon.entities.NumberFormat format : Formats) {
    ...
    private ToggleGroup getRadioGroup(ObservableList<finalon.entities.NumberFormat> formats) {
